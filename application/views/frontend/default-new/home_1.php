...
<div class="video-background">
  ...
  <a href="<?php echo site_url('#grizzly'); ?>" class="btn sp_theme_btn me-3 mb-2">Go to Markets </a>

  <a href="#vect grid-view-body2 pb-4" class="btn sp_light_border_btn mb-2">See Courses<i class="las la-arrow-right ms-2 rotate-arrow"></i></a>
  <div class="row">
            <div class="col-lg-6">
            <div class="brand-4">
            <div class="">
